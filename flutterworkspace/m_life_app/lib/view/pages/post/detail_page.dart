...
class DetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final createdPostDateTime = DateFormat("yyyy-MM-dd HH:mm").format(p.post.value.created!);
                    ...
                    builder: (context) =>
                        ConfirmationDialog(
                          ...
                          onConfirm: () async {
                            ...
                            bottomNavBarController.updateColor(0); // 인기게시판 탭 인덱스로 설정
                          },
                        ),
                  );
                }
          ...
          () => Column(
            ...
            children: [
              Row(
                children: [
                  CircleAvatar(
                    child: Image.asset("assets/copy_logo.png", color: Colors.amber,),backgroundColor: Colors.white,
                  ),
                  SizedBox(width: 15),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final createdDateTime = DateFormat("yyyy-MM-dd HH:mm").format(comment.created!);
                          final isAuthor =
